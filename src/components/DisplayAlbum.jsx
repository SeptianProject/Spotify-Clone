    ...
    return (
        <>
            ...
            <div className='grid grid-cols-3 sm:grid-cols-4 mt-10 mb-4 pl-2 text-[#a7a7a7] '>
                ...
                <p>Album</p>
                <p className='hidden sm:block'>Date Add</p>
                <img className='m-auto w-4' src={assets.clock_icon} />
            </div>
            <hr />
            {
                songsData.map((song, index) => (
                    <div onClick={() => playWithId(song.id)} key={index} className='grid grid-cols-3 sm:grid-cols-4 gap-2 p-2 items-center text-[#a7a7a7] hover:bg-[#ffffff2b]'>
